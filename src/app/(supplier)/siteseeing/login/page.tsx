...
export default function SiteSeeingLoginPage() {
       ...
       const handleLogin = async (e: React.FormEvent) => {
              ...
              try {
                     ...
                     // After login, redirect to the siteseeing dashboard
              ...
              <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-background">
                     ...
                     <div className="w-full max-w-[440px] z-10">
                            ...
                            <div className="text-center mb-10">
                                   ...
                                   <h1 className="text-3xl font-extrabold text-foreground tracking-tight mb-2">Partner Login</h1>
                                   <p className="text-muted-foreground">Manage your sightseeing tours & bookings</p>
                            </div>
                                   ...
                                   <form onSubmit={handleLogin} className="space-y-6">
                                          ...
                                          <div className="space-y-2">
                                                 <div className="flex justify-between items-center px-1">
                                                        ...
                                                        <Link
                                                               href="/siteseeing/forgot-password"
                            ...
                            <p className="text-center mt-8 text-sm text-foreground/60">
                                   ...
                                   <Link href="/siteseeing/signup" className="text-accent font-bold hover:underline transition-all">
                                          Register Now
                                   </Link>
                            </p>
                     </div>
