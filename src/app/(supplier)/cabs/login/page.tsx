                     ...
                     <div className="w-full max-w-[440px] z-10">
                            ...
                            <div className="text-center mb-10">
                                   <div
                                          ...
                                          style={{
                                                 background: 'linear-gradient(135deg, hsl(285 70% 65%), hsl(265 80% 60%))',
                                                 boxShadow: '0 8px 30px rgba(150, 50, 255, 0.4)'
                                          }}
                                   >
                                          <Car size={32} color="white" />
                                   </div>
                                   <h1 className="text-3xl font-extrabold text-[hsl(var(--foreground))] tracking-tight mb-2">Cab Agency Portal</h1>
                                   <p style={{ color: 'hsl(var(--muted-foreground))' }}>Login to manage your fleet and bookings</p>
                            </div>
                            ...
                            <div className="glass-card p-8 md:p-10 border-[var(--glass-border-light)] shadow-2xl relative">
                                   <form onSubmit={handleLogin} className="space-y-6">
                                          ...
                                          </button> <div className="mt-6 p-4 rounded-xl bg-accent/5 border border-accent/10"><p className="text-[10px] font-bold text-accent uppercase tracking-wider mb-2">Test Credentials</p><div className="flex justify-between items-center text-xs"><code className="text-foreground/70">cab@test.com</code><code className="text-foreground/70">test123</code></div></div>
                                   </form>
                            </div>

                            <p className="text-center mt-8 text-sm text-[hsl(var(--foreground))]/60">
                                   Don't have an account? {' '}
                                   <Link href="/cabs/signup" className="text-accent font-bold hover:underline transition-all">
                                          Register Cab Agency
                                   </Link>
                            </p>
                     </div>
